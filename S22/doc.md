...
| -------- | --------- | -------------- | --- | ----------- | --------------------- |
| name | Название дня недели на русском | Обязательно | string | только русские буквы, максимальное количество для ввода: 20 символов, unique | - |
| order_number | Порядковый номер дня недели | Обязательно |	integer |	от 1 до 7, unique |	- |

Уникальные комбинации параметров: name, order_number
...
| Параметр | Пояснение | Обязательность | Тип | Ограничение | Значение по умолчанию |
| -------- | --------- | -------------- | --- | ----------- | --------------------- |
| name | Название дня недели на русском | Не обязательно | string | только русские буквы, максимальное количество для ввода: 20 символов, unique | - |
...
| name | Название дня недели на русском | string |
...
| -------- | --------- | --- | -------- |
| name | Название дня недели | string | Поиск по частичному совпадению, без учета регистра |
...
| Параметр | Пояснение | Обязательность | Тип | Ограничение | Значение по умолчанию |
| -------- | --------- | -------------- | --- | ----------- | --------------------- |
| weekday_id | ID дня недели | Не обязательно | integer | внешний ключ к weekday.id, >0 | - |
| timeslot_id | ID временного слота | Не обязательно | integer | внешний ключ к timeslot.id, >0 | - |
