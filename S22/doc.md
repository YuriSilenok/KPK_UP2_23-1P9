...
| pair_number | Номер пары | Обязательно | integer | от 1 до 7, первичный ключ | - |
...
**Уникальные комбинации параметров:** pair_number
...
| pair_number | Номер пары | Не обязательно | integer | от 1 до 7, первичный ключ | - |
