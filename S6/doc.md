# Specialty Service — Сервис специальностей
...
|---|---|---|---|---|
| code | Обязательный | str | Уникальный, не пустой, макс. 20 символов | — |
| name | Обязательный | str | Не пустой, макс. 255 символов | — |
| fgos_id | Обязательный | int | Внешний ключ на FGOS | — |
| description | Необязательный | str | Макс. 1000 символов | None |
...
| Параметр | Обязательность | Тип | Ограничение | Значение по умолчанию |
|---|---|---|---|---|
| code | Необязательный | str | Уникальный, не пустой, макс. 20 символов | — |
| name | Необязательный | str | Не пустой, макс. 255 символов | — |
| fgos_id | Необязательный | int | Внешний ключ на FGOS | — |
| description | Необязательный | str | Макс. 1000 символов | — |
...
| Параметр | Обязательность | Тип | Ограничение | Значение по умолчанию |
|---|---|---|---|---|
| number | Обязательный | str | Уникальный, не пустой, макс. 50 символов | — |
| name | Обязательный | str | Не пустой, макс. 255 символов | — |
| approval_year | Обязательный | int | > 1990 | — |
...
| Параметр | Обязательность | Тип | Ограничение | Значение по умолчанию |
|---|---|---|---|---|
| number | Необязательный | str | Уникальный, не пустой, макс. 50 символов | — |
| name | Необязательный | str | Не пустой, макс. 255 символов | — |
| approval_year | Необязательный | int | > 1990 | — |
